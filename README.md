...
1. How did the number of images per class affect your model’s accuracy?
   - Classes with more images generally performed better because the model had more examples to learn the unique features of each plant.
     On the other hand, species with fewer images sometimes caused the model to misclassify, as it couldn’t fully capture their variations in shape, color, or lighting conditions.
